...
SECRET_KEY = 'django-insecure-thl+7it@6cd18i#8snkv_ri#(yzrkr27g35ke#jb$h9%s4+d+1'
...
CORS_ALLOW_ORIGINS = [
    'http://localhost:8080',
    "http://127.0.0.1:5500",  # Adicione o endereço de onde o frontend está sendo servido
    "http://localhost:5500",
